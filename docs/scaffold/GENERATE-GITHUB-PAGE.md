...
[`.github/workflows/deploy-pages.yml`](../../.github/workflows/deploy-pages.yml) are a
...
[`/init-generic-template`](INIT-GENERIC-TEMPLATE.md) takes one, because this procedure
...
[`/init-generic-template`](INIT-GENERIC-TEMPLATE.md) §1 does for its own derivations — a
...
[`/init-generic-template`](INIT-GENERIC-TEMPLATE.md) §2 refuses to make against an
...
**Read [`ONE-PAGER-TEMPLATE.html`](ONE-PAGER-TEMPLATE.html) now** — it is this section's
...
Copy [`.github/workflows/deploy-pages.yml`](../../.github/workflows/deploy-pages.yml)
