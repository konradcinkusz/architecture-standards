...
The same black-box pass as [`TEST-ON-LOCALHOST.md`](TEST-ON-LOCALHOST.md), against a
...
[`SERVICE-API-PATTERNS.md`](../guides/SERVICE-API-PATTERNS.md) and
[`SECURITY-REVIEW.md`](../guides/SECURITY-REVIEW.md) — installed as
