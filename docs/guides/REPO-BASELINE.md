...
| CI runs the linters and tests the repo claims | The committed-but-never-executed config problem ([`TESTING-STRATEGY.md`](TESTING-STRATEGY.md) §9) |
...
See [`docs/research/00-RESEARCH-DOCUMENTATION.md`](../research/00-RESEARCH-DOCUMENTATION.md)
...
trade-off, live in [`MARKETPLACE.md`](../../MARKETPLACE.md); this section exists so
...
`.github/agents/` (agent definitions), [`MARKETPLACE.md`](../../MARKETPLACE.md)
