<!-- Generated copy of docs/guides/STATE-SNAPSHOT-PERSISTENCE.md — do not edit. Relative links have been rewritten to absolute repository URLs. -->
...
**Where this sits relative to [P4](https://github.com/konradcinkusz/architecture-standards/blob/main/docs/architecture/00-REFERENCE-ARCHITECTURE.md#p4).** P4
...
This is [P8](https://github.com/konradcinkusz/architecture-standards/blob/main/docs/architecture/00-REFERENCE-ARCHITECTURE.md#p8) applied to the store: an
