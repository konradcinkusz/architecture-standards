<!-- Generated copy of docs/guides/FRONTEND-BFF.md — do not edit. Relative links have been rewritten to absolute repository URLs. -->
...
- The cookie-vs-localStorage choice is also a legal input (cookie disclosure) — see
  [`IDENTITY-AND-ACCOUNTS.md`](https://github.com/konradcinkusz/architecture-standards/blob/main/docs/guides/IDENTITY-AND-ACCOUNTS.md) §9.
...
([`PAYMENTS-AND-MONETIZATION.md`](https://github.com/konradcinkusz/architecture-standards/blob/main/docs/guides/PAYMENTS-AND-MONETIZATION.md) §7); write the hook's
