<!-- Generated copy of docs/guides/METRICS-EXPOSITION.md — do not edit. Relative links have been rewritten to absolute repository URLs. -->
...
any other public surface — see [`SERVICE-API-PATTERNS.md`](https://github.com/konradcinkusz/architecture-standards/blob/main/docs/guides/SERVICE-API-PATTERNS.md) §1 on
