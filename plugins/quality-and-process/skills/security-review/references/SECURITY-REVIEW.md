<!-- Generated copy of docs/guides/SECURITY-REVIEW.md — do not edit. Relative links have been rewritten to absolute repository URLs. -->
...
([`REPO-BASELINE.md`](https://github.com/konradcinkusz/architecture-standards/blob/main/docs/guides/REPO-BASELINE.md)) are the continuous complement, not an
alternative.
...
- HttpOnly cookies **cannot be set from `document.cookie`**; a server route sets them
  (`httpOnly`, `secure`, `sameSite` — see [`FRONTEND-BFF.md`](https://github.com/konradcinkusz/architecture-standards/blob/main/docs/guides/FRONTEND-BFF.md) §3).
...
([`SERVICE-API-PATTERNS.md`](https://github.com/konradcinkusz/architecture-standards/blob/main/docs/guides/SERVICE-API-PATTERNS.md) §3). The principles behind it:
