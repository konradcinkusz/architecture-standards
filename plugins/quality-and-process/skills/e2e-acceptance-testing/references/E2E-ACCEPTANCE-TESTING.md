<!-- Generated copy of docs/guides/E2E-ACCEPTANCE-TESTING.md — do not edit. Relative links have been rewritten to absolute repository URLs. -->
...
- **Don't try to boot the whole stack inside the CI runner** for a multi-service Aspire
  ...
  [`FLY-IO-DEPLOYMENT.md`](https://github.com/konradcinkusz/architecture-standards/blob/main/docs/guides/FLY-IO-DEPLOYMENT.md) §"PR environments" —
...
system's own repo (see [`PLAYBOOK.md`](https://github.com/konradcinkusz/architecture-standards/blob/main/docs/PLAYBOOK.md) — "Output conventions") while only
