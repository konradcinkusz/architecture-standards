<!-- Generated copy of docs/guides/DEMO-DATA-AND-SEEDING.md — do not edit. Relative links have been rewritten to absolute repository URLs. -->
...
[`STATE-SNAPSHOT-PERSISTENCE.md`](https://github.com/konradcinkusz/architecture-standards/blob/main/docs/guides/STATE-SNAPSHOT-PERSISTENCE.md) §5 for the same failure in
its own setting.
