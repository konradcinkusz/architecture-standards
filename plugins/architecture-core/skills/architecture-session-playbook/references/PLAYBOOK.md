<!-- Generated copy of docs/PLAYBOOK.md — do not edit. Relative links have been rewritten to absolute repository URLs. -->
...
- **When the session will touch Azure AI Foundry agents:** point the agent at
  [`docs/guides/AZURE-AI-FOUNDRY-AGENTS.md`](https://github.com/konradcinkusz/architecture-standards/blob/main/docs/guides/AZURE-AI-FOUNDRY-AGENTS.md) as
